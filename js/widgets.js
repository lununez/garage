    ...
    const WIDGETS = {
        ...
        slider: {
            ...
            properties: {
                ...
                adjustable: { type: 'boolean', default: true, label: 'Adjustable' },
                ...
                knob_style: { type: 'enum', default: 'circle', label: 'Knob Style',
                             options: ['circle', 'bar', 'none', 'image'] },
                knob_image: { type: 'string', default: '', label: 'Knob Image (URL)' },
                knob_width: { type: 'number', default: null, label: 'Knob Width' },
                knob_height: { type: 'number', default: null, label: 'Knob Height' },
            },
